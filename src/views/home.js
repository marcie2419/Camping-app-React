  ...
  return (
    <div className={styles['container']}>
      ...
      <div className={styles['Banner']}>
        <h1 className={styles['text01']}>Op vakantie zonder zorgen</h1>
      ...
      <div className={styles['FeatureCard']}>
        ...
        <div className={styles['container2']}>
          <h2 className={styles['text23']}>Oeps! Foutje gevonden?</h2>
          <span>
            Heb je een fout gevonden, of wil je een nieuwe functie aanvragen?
            Dat kan! Stuur een mailtje naar marc.horstra@gmail.com, of SMS naar
            06-83919623 (Lokaal tarief)
          </span>
        </div>
      </div>
    </div>
